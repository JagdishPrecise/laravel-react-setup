...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    useEffect(() => {
        ...
        if (error) {
            setError('googleLogin', error === 'access_denied' ? 'Google login was cancelled.' : error);
            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    <div className="flex flex-col gap-4">
                        <Button type="button" variant="outline" className="w-full"  onClick={() => window.location.href = '/auth/google'}>
                        ...
                        <InputError message={errors.googleLogin} />
                    </div>
                </div>
